        ...
        <div class="wrap-product-detail">
          ...
          <div class="detail-info">
            <div class="product-rating">
                          ...
                          <div class="wrap-price"><span class="product-price">BDT {{$product->sale_price}}</span>
                          <del><span class="product-price regprice">BDT {{$product->regular_price}}</span></del>
                          </div>
                          @else
                          <div class="wrap-price"><span class="product-price">BDT {{$product->regular_price}}</span></div>
                          @endif
              ...
              <li class="product-item">
                <div class="product product-widget-style">
                  ...
                  <div class="product-info">
                    ...
                    <div class="wrap-price"><span class="product-price">BDT{{$p_product->regular_price}}</span></div>
                  </div>
                </div>
              </li>
              <?php endforeach; ?>
            ...
            <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
              ...
              <div class="product product-style-2 equal-elem ">
                ...
                <div class="product-info">
                  ...
                  <div class="wrap-price"><span class="product-price">BDT{{$r_product->regular_price}}</span></div>
                </div>
              </div>
                <?php endforeach; ?>
