    ...
    <div class=" main-content-area">
      ...
      <div class="wrap-iten-in-cart">
        ...
        <ul class="products-cart">
          ...
          <li class="pr-cart-item">
            ...
            <div class="price-field produtc-price"><p class="price">BDT{{$item->model->regular_price}}</p></div>
            <div class="quantity">
            ...
            <div class="price-field sub-total"><p class="price">BDT{{$item->subtotal}}</p></div>
            <div class="delete">
      ...
      <div class="summary">
        <div class="order-summary">
          ...
          <p class="summary-info"><span class="title">Subtotal</span><b class="index">BDT{{Cart::subtotal()}}</b></p>
          <p class="summary-info"><span class="title">Tax</span><b class="index">BDT{{Cart::tax()}}</b></p>
          <p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
          <p class="summary-info total-info "><span class="title">Total</span><b class="index">BDT{{Cart::total()}}</b></p>
        </div>
